...
public class UpdateSupplierRecordJFrame extends javax.swing.JFrame {
    ...
    public UpdateSupplierRecordJFrame() {
        initComponents();
    }

    public UpdateSupplierRecordJFrame(int rowId) {
        initComponents();
        ...
        try {
            ...
            String query = "SELECT * FROM suppliers WHERE sup_id = " + id + ";";
            ResultSet resultSet = stmt.executeQuery(query);
            if (resultSet.next()) {
                String supName = resultSet.getString("sup_name");
                String supProd = resultSet.getString("sup_prod");
                String phoneNo = resultSet.getString("phone_no");
                String emailAddr = resultSet.getString("email_addr");
                String address = resultSet.getString("address");

                jTextFieldSupplierId.setText(Integer.toString(id));
                jTextFieldSupplierName.setText(supName);
                jTextFieldProduct.setText(supProd);
    ...
    private void initComponents() {
        ...
        jLabelUpdateSupplierRecord = new javax.swing.JLabel();
        jButtonClose = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Update Customer Record");
        setName("frameUpdateSuplierRecord"); // NOI18N
        setResizable(false);
        ...
        jLabelUpdateSupplierRecord.setFont(new java.awt.Font("Harrington", 1, 24)); // NOI18N
        jLabelUpdateSupplierRecord.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelUpdateSupplierRecord.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-update-48.png"))); // NOI18N
        jLabelUpdateSupplierRecord.setText("<html> \t<b style=\"color: #6f4e37;\"> \t\t&nbsp;Update Supplier Record \t</b> </html>");
        ...
        jPanelBackgroundLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelBackgroundLayout.createSequentialGroup()
                ...
                .addGroup(jPanelBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabelUpdateSupplierRecord))
                .addContainerGap())
        );
        jPanelBackgroundLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelBackgroundLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelUpdateSupplierRecord, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        if (supName.trim().isEmpty()) {
            ...
            try {
                ...
                String query = "UPDATE suppliers "
                        + "SET sup_name = '" + supName + "', sup_prod = '" + supProd + "', phone_no = '" + phoneNo + "', email_addr = '" + emailAddr + "', address = '" + address + "'"
                        + "WHERE sup_id = " + id + ";";
                if (stmt.executeUpdate(query) != 0) {
                    JOptionPane.showMessageDialog(this, "Supplier Record Updated Successfully...");
                } else {
                    JOptionPane.showMessageDialog(this, "Failed to Update Supplier Record...");
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSupplierRecordJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateSupplierRecordJFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabelUpdateSupplierRecord;
