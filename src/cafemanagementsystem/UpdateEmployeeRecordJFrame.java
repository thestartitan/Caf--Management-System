...
public class UpdateEmployeeRecordJFrame extends javax.swing.JFrame {

    /**
     * Creates new form UpdateEmployeeRecordJFrame
     */
    int id;
    ...
    public UpdateEmployeeRecordJFrame() {
        initComponents();
    }

    public UpdateEmployeeRecordJFrame(int rowId) {
        initComponents();
        ...
        try {
            ...
            String query = "SELECT emp_name, phone_no, emp_title, gender, DAY(emp_doj), MONTH(emp_doj), YEAR(emp_doj), email_addr, address "
            ...
            if (resultSet.next()) {
                ...
                int day = (resultSet.getInt("DAY(emp_doj)") - 1);
                int month = (resultSet.getInt("MONTH(emp_doj)") - 1);
                int year = resultSet.getInt("YEAR(emp_doj)");
                ...
                jTextFieldEmployeeName.setText(empName);
                jTextFieldPhoneNumber.setText(phoneNo);
                jComboBoxEmployeeTitle.setSelectedItem(empTitle);
                ...
                jTextAreaResidence.setText(residence);
    ...
    private void initComponents() {
        ...
        setName("frameUpdateEmployeeRecord"); // NOI18N
        setResizable(false);
        ...
        jLabelAddStockRecord.setText("<html> \t<b style=\"color: #6f4e37;\"> \t\t&nbsp;Update Employee Record \t</b> </html>");
        ...
        if (empName.trim().isEmpty()) {
            ...
            try {
                ...
                String query = "Update employees "
                        + "SET emp_name = '" + empName + "', phone_no = '" + phoneNo + "', emp_title = '" + empTitle + "', gender = '" + gender + "', emp_doj = '" + dateOfJoining + "', email_addr = '" + emailAddr + "', address = '" + residence + "' "
                        + "WHERE emp_id = " + id + ";";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateEmployeeRecordJFrame.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateEmployeeRecordJFrame().setVisible(true);
            }
        });
    }
