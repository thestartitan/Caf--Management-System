...
public class ManageSupplierJFrame extends javax.swing.JFrame {

    /**
     * Creates new form ManageSupplierJFrame
     */
    int rowId;
    ...
    public void refreshRecords() {
        DefaultTableModel supplierRecordsTable = (DefaultTableModel) jTableSupplierRecords.getModel();

        int tableRows = supplierRecordsTable.getRowCount();
        if (tableRows > 0) {
            for (int i = 0; i < tableRows; i++) {
                supplierRecordsTable.removeRow(0);
            }
        }
        ...
        try {
            ...
            if (resultSet.next()) {
                do {
                    ...
                    supplierRecordsTable.addRow(new Object[]{
                        id, supName, supProd, phoneNo, emailAddr, address
                    });
                } while (resultSet.next());
            } else {
                JOptionPane.showMessageDialog(null, "No Supplier Record to Load...");
            }
    ...
    private void initComponents() {
        ...
        jTableSupplierRecords = new javax.swing.JTable();
        jButtonRemove = new javax.swing.JButton();
        jLabelSupplierManagement = new javax.swing.JLabel();
        ...
        setTitle("Cafe Management System - Supplier Management");
        setName("frameSupplierManagement"); // NOI18N
        setUndecorated(true);
        setResizable(false);
        ...
        jTableSupplierRecords.setFont(new java.awt.Font("Lucida Handwriting", 0, 14)); // NOI18N
        jTableSupplierRecords.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Supplier ID", "Supplier Name", "Product", "Phone Number", "Email", "Address"
            }
        ) {
        ...
        jTableSupplierRecords.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jTableSupplierRecords.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableSupplierRecordsMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableSupplierRecords);
        ...
        jLabelSupplierManagement.setFont(new java.awt.Font("Harrington", 0, 36)); // NOI18N
        jLabelSupplierManagement.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelSupplierManagement.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-supplier-64.png"))); // NOI18N
        jLabelSupplierManagement.setText("<html> \t<b style=\"color: #6f4e37;\"> \t\t&nbsp;Cafe Management System - Supplier Management \t</b> </html>");
        ...
        jPanelSearch.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Search Supplier Record", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Handwriting", 0, 14))); // NOI18N
        ...
        jComboBoxAttribute.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Supplier id", "Supplier Name", "Product", "Phone Number", "Email", "Address" }));
        ...
        jPanelBackgroundLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelBackgroundLayout.createSequentialGroup()
                ...
                .addGroup(jPanelBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabelSupplierManagement, javax.swing.GroupLayout.DEFAULT_SIZE, 1580, Short.MAX_VALUE)
        ...
        jPanelBackgroundLayout.setVerticalGroup(
            ...
            .addGroup(jPanelBackgroundLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(jLabelSupplierManagement, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        if (rowId != 0) {
            new UpdateSupplierRecordJFrame(rowId).setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "No Supplier Record Selected...");
        }
    ...
    private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveActionPerformed
        if (rowId != 0) {
            try {
                ...
                Statement stmt = (Statement) conn.createStatement();
                String query = "DELETE FROM suppliers WHERE sup_id = '" + rowId + "';";
                if (stmt.executeUpdate(query) != 0) {
                    JOptionPane.showMessageDialog(this, "Suplier Record Removed Successfully...");
                } else {
                    JOptionPane.showMessageDialog(this, "Failed to Remove Supplier Record...");
                }
            } catch (ClassNotFoundException | SQLException exce) {
    ...
    private void jButtonSearchRecordsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchRecordsActionPerformed
        ...
        if (!value.trim().isEmpty()) {
            ...
            try {
                ...
                Statement stmt = (Statement) conn.createStatement();
                String query = "SELECT * FROM suppliers WHERE " + attribute + " LIKE '%" + value + "%';";
                ResultSet resultSet = stmt.executeQuery(query);
                if (resultSet.next()) {
                    do {
                        int id = resultSet.getInt("sup_id");
    ...
    private void jTableSupplierRecordsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableSupplierRecordsMouseClicked
        DefaultTableModel supplierRecordsTable = (DefaultTableModel) jTableSupplierRecords.getModel();
        int selectedRowIndex = jTableSupplierRecords.getSelectedRow();
        rowId = (int) supplierRecordsTable.getValueAt(selectedRowIndex, 0);

    }//GEN-LAST:event_jTableSupplierRecordsMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageSupplierJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel jLabelSupplierManagement;
    private javax.swing.JLabel jLabelValue;
    private javax.swing.JPanel jPanelBackground;
    private javax.swing.JPanel jPanelSearch;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JTable jTableSupplierRecords;
